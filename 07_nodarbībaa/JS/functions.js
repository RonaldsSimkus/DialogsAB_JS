...
console.log(
  "Pirmā rezultāta vērtība pēc funkcijas darbināšanas: " +
    funkcijas_darbiibas_rezultaati[0]
);
console.log(
  "Otrā rezultāta vērtība pēc funkcijas darbināšanas: " +
    funkcijas_darbiibas_rezultaati[1]
);
